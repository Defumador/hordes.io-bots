...
def choose_character():
    ...
    for _class in Character:
        if _class.value[1] == (_id - 1):  # index of _class == id - 1
            return _class.value[0]  # return the character
...
def parse_arguments():
    ...
    parser.add_argument('--path', default='C:\George\PyCharm_Files\Hordes\drivers\chromedriver.exe', type=str, dest="path", help="Path to chromedriver.exe")
